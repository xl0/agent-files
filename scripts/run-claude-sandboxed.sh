...
print_help() {
  cat >&2 <<EOF
Usage: $prog_name [--no-ssh] [--no-ssh-agent] [--no-runtime] [--ro-runtime] [--ro-bun] [--ro-npm] [--ro-cache] [--ro-rust] [--ro-conda] [--ro-vscode] [--ro-node-modules] [--no-cuda] [--writable PATH ...] [CLAUDE_ARG ...]
